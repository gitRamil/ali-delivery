...
namespace Ali.Delivery.Order.Infrastructure.Migrations
{
    ...
    [Migration("20250301120651_UpdateNotAuthUsers")]
    partial class UpdateNotAuthUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.Dictionaries.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a1844b2-1e60-6e25-1bcf-da74b2a4f07c"),
                            Code = "courier",
                            Name = "Курьер"
                        },
                        new
                        {
                            Id = new Guid("3a1844b2-1e4f-f70c-c599-5fe824c7a873"),
                            Code = "basicUser",
                            Name = "Пользователь"
                        },
                        new
                        {
                            Id = new Guid("3a1844b2-1e61-d7b0-a9f6-8ec08e2c69fd"),
                            Code = "notAuthUser",
                            Name = "Неавторизованный пользователь"
                        },
                        new
                        {
                            Id = new Guid("3a1844b2-1e63-f523-2f04-f4eb3bad17b3"),
                            Code = "superUser",
                            Name = "Пользователь с полным доступом"
                        });
                });
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.NotAuthUser", b =>
                {
                    ...
                    b.HasIndex("creator_user_id")
                        .HasDatabaseName("ix_not_auth_users_creator_user_id");

                    b.ToTable("not_auth_users", null, t =>
                        {
                            t.HasComment("Незарегистрированные пользователи");
                        });
                });
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e61-d7b0-a9f6-8ec08e2c69fd"),
                            PermissionId = new Guid("3a17be54-4e81-b978-5d49-940a8c2da6ab"),
                            Id = new Guid("3a1844e7-40b5-634c-f5e0-662dfe13dff1")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e4f-f70c-c599-5fe824c7a873"),
                            PermissionId = new Guid("3a17be54-4e82-4bfb-f422-2caeb3389561"),
                            Id = new Guid("3a1844e7-409f-dd6f-39ed-1f2f67aef722")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e4f-f70c-c599-5fe824c7a873"),
                            PermissionId = new Guid("3a17be54-4e81-b978-5d49-940a8c2da6ab"),
                            Id = new Guid("3a1844e7-40b0-0bdb-5ad3-309f135ff5e2")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e4f-f70c-c599-5fe824c7a873"),
                            PermissionId = new Guid("3a17be54-4e84-3e77-9188-a292bac6366c"),
                            Id = new Guid("3a1844e7-40b1-d958-4573-cc84183ec531")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e60-6e25-1bcf-da74b2a4f07c"),
                            PermissionId = new Guid("3a17be54-4e83-e173-197a-4a19535ed222"),
                            Id = new Guid("3a1844e7-40b2-9ae9-56c9-27598b808a43")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e60-6e25-1bcf-da74b2a4f07c"),
                            PermissionId = new Guid("3a17be54-4e84-3e77-9188-a292bac6366c"),
                            Id = new Guid("3a1844e7-40b3-790d-6f17-ffa82729df95")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e60-6e25-1bcf-da74b2a4f07c"),
                            PermissionId = new Guid("3a17be54-4e81-b978-5d49-940a8c2da6ab"),
                            Id = new Guid("3a1844e7-40b4-6c99-9ee8-c6ed4958ad43")
                        },
                        new
                        {
                            RoleId = new Guid("3a1844b2-1e63-f523-2f04-f4eb3bad17b3"),
                            PermissionId = new Guid("3a17be54-4e65-5dca-866e-f7cd3b8c49bb"),
                            Id = new Guid("3a1844e7-40b6-8c81-44cf-f1ff77037740")
                        });
                });
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.NotAuthUser", b =>
                {
                    b.HasOne("Ali.Delivery.Order.Domain.Entities.User", "Creator")
                        .WithMany("NotAuthUsers")
                        .HasForeignKey("creator_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_not_auth_users_users_creator_user_id");
