...
namespace Ali.Delivery.Order.Infrastructure.Migrations
{
    ...
    [Migration("20250210181026_AddNotAuthUserIntoOrder")]
    partial class AddNotAuthUserIntoOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.NotAuthUser", b =>
                {
                    ...
                    b.HasIndex("creator_id")
                        .HasDatabaseName("ix_not_auth_users_creator_id");

                    b.HasIndex("role_id")
                        .HasDatabaseName("ix_not_auth_users_role_id");

                    b.ToTable("notAuthUsers", null, t =>
                        {
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.PassportInfo", b =>
                {
                    ...
                    b.Property<string>("PassportInfoIssuedBy")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
            ...
            modelBuilder.Entity("Ali.Delivery.Order.Domain.Entities.NotAuthUser", b =>
                {
                    b.HasOne("Ali.Delivery.Order.Domain.Entities.User", "Creator")
                        ...
                        .HasConstraintName("fk_not_auth_users_users_creator_id");
                    ...
                    b.HasOne("Ali.Delivery.Order.Domain.Entities.Dictionaries.Role", "Role")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_not_auth_users_roles_role_id");
