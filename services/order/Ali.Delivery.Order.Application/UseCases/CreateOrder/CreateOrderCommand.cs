...
public record CreateOrderCommand(string OrderName, decimal Weight, SizeCode Size, decimal Price, string AddressFrom, string AddressTo, OrderStatus OrderStatus, Guid SenderId, Guid ReceiverId ) : IRequest<Guid>;
