...
/// </summary>
public class GetRolesForUserRegistrationCommandHandler : IRequestHandler<GetRolesForUserRegistrationCommand, List<RoleDto>>
{
    private readonly IAppDbContext _context;

    /// <summary>
    /// Инициализирует новый экземпляр <see cref="GetRolesForUserRegistrationCommandHandler" />.
    /// </summary>
    /// <param name="context">Контекст БД.</param>
    public GetRolesForUserRegistrationCommandHandler(IAppDbContext context) => _context = context ?? throw new ArgumentNullException(nameof(context));
