...
order_info2 AS (
    INSERT INTO order_details (id ,address_from, address_to, price, weight, size_id, created_by, created_date, updated_by, updated_date)
    VALUES ('b4b4bb92-66cb-4bfb-91df-70b8aa450f79'::uuid, 'admin', NOW(), 'Заказ 1', 'admin', NOW(), null, (SELECT id FROM order_info1), NULL, (SELECT id FROM users WHERE login = 'Basic'), (SELECT id FROM users WHERE login = 'Basic1'), '3a174d9d-c0e0-b9f8-286f-aa381bbf2d0a');
    RETURNING id
),
order_info3 AS (
    INSERT INTO order_details (id ,address_from, address_to, price, weight, size_id, created_by, created_date, updated_by, updated_date)
    VALUES ('32b1cc5e-285b-4d24-8734-19d6c2752a42'::uuid, '1990-01-01', NOW(), 'Admin', 'Admin', 'Admin', '$2a$11$2OUblbk4LfMfGreEbndQIePViRI8JraT01MUiXAorN4yeCyUkq9z6', '3a1844b2-1e63-f523-2f04-f4eb3bad17b3');
    RETURNING id
),
order_info4 AS (
    INSERT INTO order_details (id ,address_from, address_to, price, weight, size_id, created_by, created_date, updated_by, updated_date)
